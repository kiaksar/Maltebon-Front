                    ...
                    <Grid container spacing={1} direction={"column"}>
                        <Grid item lg={12} xs={12} md={12} style={{margin:'auto', textAlign:'center'}}>
                            <Grid container spacing={1} direction={"column"}>
                                ...
                                <Grid item lg={12} xs={12} md={12} style={{margin:'auto', textAlign:'center'}}>
                                    <TextField onChange={(e)=>{this.setState({username:e.target.value})}} id="outlined-basic" label="Email" variant="filled" />
                                </Grid>
                                <Grid item lg={12} xs={12} md={12} style={{margin:'auto', textAlign:'center'}}>
                                ...
                                <Grid item lg={12} xs={12} md={12} style={{margin:'auto', textAlign:'center', width:"100%"}}>
                                    <Button onClick={this.handleLogin} type="button" color="primary" style={{width:"100%"}}>
                                        Log in
                                    </Button>
                                </Grid>
                            </Grid>
